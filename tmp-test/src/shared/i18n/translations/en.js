...
exports.enTranslations = {
    ...
    noDescription: 'No description was provided. Touch base with operations if you need the rundown.',
    needAHand: 'Need a hand?',
    reachOutCopy: 'Reach out to {contact} if anything changes or if you need a quick refresher before clocking in.',
    callLabel: 'Call',
    emailLabel: 'Email',
    phoneLabel: 'Mobile',
    ...
    shiftSyncFailedMessage: 'We could not load your assignments right now. Retry or contact support if the issue persists.',
    ...
    statusInProgressDescription: 'You are currently on the clock—wrap up the essentials and keep the momentum.',
    ...
    emailNotificationsTrendHint: '{count} notifications in the last 7 days. Recommended: {frequency}.',
    ...
    security2faNotVerified: 'No verified 2FA factor found yet. Contact support to complete setup if required.',
    ...
    appErrorBody: 'The app caught an unexpected error. Please retry. If this keeps happening, restart the app.',
    notFoundHeading: 'Employee Portal',
    notFoundSummaryOne: 'Employee Portal is an Expo app backed by Supabase for shift data plus shared Prisma/Next.js tooling.',
    notFoundSummaryTwo: 'Copy .env.example to .env, fill SUPABASE_URL and keys, and run npm run check-db-config before starting Metro.',
    notFoundSummaryThree: 'Use npm run start / android / ios / web to preview the app, and keep the Supabase project aligned with the Next.js config.',
    notFoundSummaryFour: 'Location access is intentionally disabled in Expo dev builds unless ENABLE_LOCATION_IN_DEV=true to avoid simulator issues.',
    notFoundSummaryFive: 'Magic-link auth is planned; the README captures how the key-sharing works across mobile and web.',
    retry: 'Retry',
    back: 'Back',
};
