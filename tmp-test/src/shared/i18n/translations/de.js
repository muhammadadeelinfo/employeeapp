...
exports.deTranslations = {
    ...
    noDescription: 'Keine Beschreibung hinterlegt. Kontaktiere das Einsatzteam, wenn du eine kurze Zusammenfassung brauchst.',
    needAHand: 'Brauchst du Hilfe?',
    reachOutCopy: 'Kontaktiere {contact}, wenn sich etwas ändert oder du vor dem Einchecken noch einmal kurz den Ablauf durchgehen möchtest.',
    callLabel: 'Anruf',
    emailLabel: 'E-Mail',
    phoneLabel: 'Handy',
    ...
    shiftSyncFailedMessage: 'Wir konnten deine Einsätze gerade nicht laden. Bitte erneut versuchen oder das Support-Team kontaktieren.',
    ...
    statusInProgressDescription: 'Du bist aktuell im Einsatz – erledige die wichtigsten Aufgaben und bleib im Flow.',
    ...
    emailNotificationsSubtitle: 'Passe den E-Mail-Versand basierend auf deinen aktuellen Benachrichtigungstrends an.',
    ...
    emailNotificationsTrendHint: '{count} Benachrichtigungen in den letzten 7 Tagen. Empfohlen: {frequency}.',
    ...
    guestPerksHeroSubtitle: 'Wellness-Zuschüsse bis zum frühen Gehaltszugriff – so profitieren unsere Teams im Alltag.',
    ...
    security2faNotVerified: 'Es wurde noch kein verifizierter 2FA-Faktor gefunden. Kontaktiere den Support, um die Einrichtung abzuschließen.',
    ...
    appErrorBody: 'Die App hat einen unerwarteten Fehler abgefangen. Bitte versuche es erneut. Wenn es weiterhin passiert, starte die App neu.',
    notFoundHeading: 'Employee Portal',
    notFoundSummaryOne: 'Employee Portal ist eine Expo-App mit Supabase für Schichtdaten sowie gemeinsamer Prisma/Next.js-Integration.',
    notFoundSummaryTwo: 'Kopiere .env.example nach .env, trage SUPABASE_URL und Schlüssel ein und führe vor Metro-Start npm run check-db-config aus.',
    notFoundSummaryThree: 'Nutze npm run start / android / ios / web für Vorschauen und halte das Supabase-Projekt mit der Next.js-Konfiguration synchron.',
    notFoundSummaryFour: 'Der Standortzugriff ist in Expo-Dev-Builds absichtlich deaktiviert, außer ENABLE_LOCATION_IN_DEV=true ist gesetzt.',
    notFoundSummaryFive: 'Magic-Link-Login ist geplant; im README steht, wie die Schlüssel zwischen Mobile und Web geteilt werden.',
