export const enTranslations = {
    ...
    biometricUnlockSetting: '{biometric} sign-in',
    biometricStatusChecking: 'Checking availability...',
    biometricStatusUnavailable: 'Not available on this device',
    biometricStatusEnabled: '{biometric} enabled for this account',
    biometricStatusDisabled: 'Disabled',
    biometricEnablePrompt: 'Confirm {biometric} sign-in setup',
    biometricEnableUnavailableBody: 'No enrolled Face ID/Touch ID found on this device.',
    biometricEnableFailedBody: 'Biometric setup was not completed.',
    biometricEnableSuccessBody: 'Biometric sign-in is now enabled.',
    biometricUnlockTitle: 'Unlock Shiftor Employee',
    biometricUnlockBody: 'Use {biometric} to continue.',
    biometricUnlockPrompt: 'Unlock with {biometric}',
    biometricUsePasscode: 'Use Passcode',
    biometricUnlocking: 'Verifying...',
    biometricUnlockAction: 'Unlock with {biometric}',
    biometricUnlockCancelled: 'Unlock was cancelled. Try again to continue.',
    biometricUnlockFailed: 'Biometric verification failed.',
    biometricUnlockPreparing: 'Preparing secure unlock...',
