export const deTranslations = {
    ...
    biometricUnlockSetting: '{biometric}-Anmeldung',
    biometricStatusChecking: 'Verfügbarkeit wird geprüft...',
    biometricStatusUnavailable: 'Auf diesem Gerät nicht verfügbar',
    biometricStatusEnabled: '{biometric} ist für dieses Konto aktiviert',
    biometricStatusDisabled: 'Deaktiviert',
    biometricEnablePrompt: '{biometric}-Anmeldung bestätigen',
    biometricEnableUnavailableBody: 'Auf diesem Gerät ist keine Face ID/Touch ID eingerichtet.',
    biometricEnableFailedBody: 'Die biometrische Einrichtung wurde nicht abgeschlossen.',
    biometricEnableSuccessBody: 'Biometrische Anmeldung ist jetzt aktiviert.',
    biometricUnlockTitle: 'Shiftor Employee entsperren',
    biometricUnlockBody: 'Mit {biometric} fortfahren.',
    biometricUnlockPrompt: 'Mit {biometric} entsperren',
    biometricUsePasscode: 'Code verwenden',
    biometricUnlocking: 'Wird geprüft...',
    biometricUnlockAction: 'Mit {biometric} entsperren',
    biometricUnlockCancelled: 'Entsperren wurde abgebrochen. Bitte erneut versuchen.',
    biometricUnlockFailed: 'Biometrische Prüfung fehlgeschlagen.',
    biometricUnlockPreparing: 'Sicheres Entsperren wird vorbereitet...',
