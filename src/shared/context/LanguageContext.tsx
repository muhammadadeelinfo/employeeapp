...
const translations = {
  en: {
    ...
    calendarLegendShift: 'Schichteinsatz',
    calendarLegendImported: 'Importierte Kalender',
    calendarLegendPink: 'Externe Feiertage / importierte Quelle',
    calendarLegendShiftGroup: 'Markierungen',
    calendarLegendTimeGroup: 'Tageszeit-Icons',
    ...
    calendarLegendShift: 'Shift assignment',
    calendarLegendImported: 'Imported calendars',
    calendarLegendPink: 'External holidays/imported feed',
    calendarLegendShiftGroup: 'Shift dots',
    calendarLegendTimeGroup: 'Time-of-day icons',
    calendarLegendMorning: 'Morning shift',
    calendarLegendEvening: 'Evening shift',
    calendarLegendNight: 'Night shift',
    reportsTitle: 'Reports',
    reportGeneratePdf: 'Generate monthly PDF',
    reportDownloadSummary: 'Download summary',
    reportGeneratedTitle: 'Report ready',
    reportGeneratedBody: 'The report has been generated; check your downloads.',
    reportMonthlyDescribe: 'Monthly breakdown of your upcoming work hours.',
    reportSummaryDescribe: 'Quick summary of the latest assignments.',
  ...
  de: {
    ...
    reportGeneratePdf: 'Monats-PDF erstellen',
    reportDownloadSummary: 'Zusammenfassung herunterladen',
    reportGeneratedTitle: 'Bericht bereit',
    reportGeneratedBody: 'Der Bericht wurde generiert; überprüfe deinen Download-Ordner.',
    reportMonthlyDescribe: 'Monatliche Übersicht über deine bevorstehenden Arbeitszeiten.',
    reportSummaryDescribe: 'Kurze Zusammenfassung der letzten Einsätze.',
