...
const translations = {
  en: {
    ...
    calendarSwitcherLabel: 'Change month',
    calendarSwitcherHint: 'Tap arrows or swipe sideways',
  ...
  de: {
    ...
    calendarSwitcherLabel: 'Monat ändern',
    calendarSwitcherHint: 'Tippe auf Pfeile oder wische zur Seite',
